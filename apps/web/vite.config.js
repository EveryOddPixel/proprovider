...
// `firebase` is a multi-entry package with no root ("." ) export, so Vite can't
// pre-bundle the bare specifier. Replace it with the subpaths the app imports.
const allDeps = Object.keys(pkg.dependencies || {})
	.filter((d) => d !== 'firebase')
	.concat(['firebase/app', 'firebase/auth', 'firebase/firestore', 'firebase/analytics']);
